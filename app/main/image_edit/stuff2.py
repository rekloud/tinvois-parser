    ...
    for rho, theta in lines[n1]:
        ...
        if n1 == 0:
            ...
            closeness_rho = np.isclose(
                rho, strong_lines[0:n2, 0, 0], atol=max(image.shape) / 10
            )  # One-tenth of the image width/height
...
if not np.isclose(far_point1[0][0], xwMAX, atol=10) and not np.isclose(
    far_point2[0][0], xwMAX, atol=10
):
